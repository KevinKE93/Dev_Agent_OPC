...
4. Write `<project-name>/specs/SPEC.md` as the product-level technical expectation source: stack constraints, host needs, source boundary expectations, commands, data/domain model, interfaces, code style, test strategy, privacy/security boundaries, risks, success criteria, and open questions.
