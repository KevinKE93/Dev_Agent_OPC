...
- Build: create/read `tasks/TECHNICAL_PLAN.md` before implementation; then read the current build slice, implementation trace, required design docs/packages, nearby source files, tests, host requirements, and `reviews/UI_DEBT.md` only when polish debt exists.
