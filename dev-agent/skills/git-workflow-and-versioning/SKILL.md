...
Target ~100 lines per commit/PR. Changes over ~1000 lines should be split using vertical slices, contract-first slices, or risk-first slices from `incremental-implementation`.
