...
5. Product-designer output is direction only. If high-fidelity UI is required, route it into Image Gen/GPT Image, Figma, human design, external design tooling, or a design-system export.
6. Do not use sketches, prototypes, local HTML, or runtime screenshots as build inputs. Satisfy `dev-agent/references/design-artifacts.md` when formal visual assets or HTML/CSS companion packages are needed.
