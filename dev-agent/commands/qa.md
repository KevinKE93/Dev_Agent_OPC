...
5. For `VISUAL_QA`, compare implemented UI with required design contract inputs and record `.dev-agent/reviews/VISUAL_COMPARISON.md` with `Overall score: N/100`.
